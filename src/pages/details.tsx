import { getOneCharacter, Result } from "@/api/callApi";
...
export const getServerSideProps = async (
    ...
    const param = (context.query.idCharacter as string) || ""; // esta sentencia se hace asi para que la peticion a la hora de buscar la url no sea null o undefined, coloco la opción de que por defecto puede ser un string vacío, ya que yo puedo ir a la url sin parámetro y el atributo no va a existir

    let response = null;

    if(param !== ""){
        response = await getOneCharacter(param);
    }
        ...
        <>
            ...
            <main className="flex flex-col items-center min-h-screen py-5 max-w-[300px] mx-auto">
                <div className="border">
                    <img src={props.response?.image} alt="img-c" />
